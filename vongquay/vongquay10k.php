            ...
            <div class="c-navbar-wrapper clearfix">
                ...
                <nav class="c-mega-menu c-pull-right c-mega-menu-dark c-mega-menu-dark-mobile c-fonts-uppercase c-fonts-bold">
                    <ul class="nav navbar-nav c-theme-nav">
                        ...
                        <li class="c-menu-type-classic">
                            <a rel="" href="https://langnam.online/" class="c-link dropdown-toggle ">Mua lượt quay</a>
                        </li>
                        <li class="c-menu-type-classic">
                            <a rel="" href="https://langnam.online/vongquay/giohang.php" class="c-link dropdown-toggle ">Nhận dồ vòng quay may mắn</a>
                        </li>
                        <li class="c-menu-type-classic">
...
<div class="c-content-title-1 pd50">
    <h3 class="c-center c-font-uppercase c-font-bold">Vòng quay may mắn thường</h3>
...
<script>
    var matkhau = "";
    var solanquay = <?php echo $_luotquay_10k ?>;
...
$( ".lammoipopupnhantien" ).hover(
  function() {
    ...
    'segments': [{
        ...
        'fillStyle': '#910f06',
        'text': '5 NLMD vàng cấp 3',
        'size': winwheelPercentToDegrees(22),
        'textFontSize': 15,
        'textFillStyle': '#ffffff',
        ...
        'fillStyle': '#910f06',
        'text': '5 NLMD tím cấp 3',
        'size': winwheelPercentToDegrees(16),
        'textFontSize': 15,
        'textFillStyle': '#ffffff',
        ...
        'fillStyle': '#ab6f03',
        'text': '5 NLMD vàng cấp 3',
        'size': winwheelPercentToDegrees(21),
        'textFontSize': 15,
        'textFillStyle': '#ffffff',
        'image': 'img/20000.png' // Hình ảnh cho 20.000 VNĐ
    }, {
        'fillStyle': '#910f06',
        'text': 'Trứng thiên thần',
        'size': winwheelPercentToDegrees(5),
        'textFontSize': 15,
        'textFillStyle': '#ffffff',
        ...
        if (indicatedSegment.text == 'Ô mất lượt') {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    vongquay: "10k"// Tên vật phẩm quay trúng
                },
                success: function(response) {
