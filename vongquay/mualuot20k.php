...
if(isset($_SESSION['user']) ) {
    if(isset($_POST['luotquay'])) {
        ...
        $trucoin = $luotquay * 20000; // Tính số coin cần trừ dựa trên số lượt quay
        ...
        if ($result_check_coins->num_rows > 0) {
            ...
            if ($user_coins >= $trucoin) {
                ...
                $sql_deduct_coins = $config->prepare("UPDATE account SET coin = coin - ?, luotquay_20k = luotquay_20k + ? WHERE user = ?");
...
<h2><b>Mua lượt quay cao cấp 20k</b></h2>
<br>
