...
<div class="c-content-title-1 pd50">
    <h3 class="c-center c-font-uppercase c-font-bold">Vòng quay may mắn VIP 50k</h3>
...
<script>
    var matkhau = "";
    var solanquay = <?php echo $_luotquay_50k ?>;
...
$( ".lammoipopupnhantien" ).hover(
  function() {
    ...
    'segments': [{
        ...
        'fillStyle': '#ab6f03',
        'text': '20 NLMD tím cấp 3',
        'size': winwheelPercentToDegrees(17),
        'textFontSize': 15,
        'textFillStyle': '#ffffff',
        ...
        if (indicatedSegment.text == 'Ô mất lượt') {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    vongquay: "50k"// Tên vật phẩm quay trúng
                },
                success: function(response) {
