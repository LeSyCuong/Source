...
$_title = "Hiệp Sĩ Làng Đá - Đăng Nhập Sever 2";
...
if ($_login == null) {
    if (isset($_POST['username'])) {
        ...
        $select = _fetch2(_select("*",'account',"user='$user'"));
		if ($select['user'] == $user) {
        if ($select['pass'] == $pass) {
            $_SESSION['user2'] = $user;
            ...
            <section class="section section--2"> 
                ...
                <div>
                    <div class="container">
                        ...
                        <!-- Registration Button -->
                        <div class="form-group">
                            <p>Nếu chưa có tài khoản <a href="/dangky-sv1"><button type="button">Đăng ký sv1</button></a></p>
                        </div>
                    </div>
                </div>
            </section>
