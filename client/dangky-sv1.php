...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // Get the form data
    $username = isset_sql2(trim($_POST['username']));
    $password = isset_sql2(trim($_POST['password']));
    $confirm_password = isset_sql2(trim($_POST['confirm_password']));
    ...
    if (empty($username) || empty($password) || empty($confirm_password)) {
        ...
        $existing_user = _fetch2("SELECT * FROM account WHERE user='$username'");
        if ($existing_user) {
        ...
        >
         ...
         <br> <br> <br> <br>
          <section class="section section--2"> <br> <br> <br> <br>
            ...
            <div class="container">
                <h2>Đăng ký tài khoản Sever 1</h2>
                ...
                <form method="post">
				 ...
				 <div class="form-group">
                            <p>Nếu đã có tài khoản <a href="/dangnhap-sv1"><button type="button">Đăng nhập sv1</button></a></p>
                        </div>
            </div>
