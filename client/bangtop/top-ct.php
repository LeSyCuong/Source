...
<body>
    ...
    >
      ...
      >
       ...
       <div class="container">
        <h1>Top Chiến Trường</h1>
        <table>
            <thead>
                <tr>
                    <th>STT</th>
                    <th>Tên tài khoản</th>
					<th>Điểm chiến trường</th>
                </tr>
            </thead>
            <tbody>
                <?php 
                ...
                // Truy vấn SQL
                $query = "SELECT name, SUM(pointarena) AS pointarena FROM `player` GROUP BY name ORDER BY pointarena DESC LIMIT 10";
