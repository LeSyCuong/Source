...
$cap15 = '['. $canh .',1,15,[[14,2500],[15,2000],[16,2000],[17,2000],[18,2000],[19,2000],[20,2000],[25,200],[27,20000],[29,1000],[30,1000],[35,1500],[38,1]],0]';
...
<form action="/canh-pt" method="POST" id="info_form">
 <?php echo $thongbao; ?><br>
<label for="new_canh">ID cánh:</label>
<div class="image-container " name="new_canh" id="new_canh">
    <div class="image-item">
        <img src="/images/webshop/15000.png" alt="Image 1" data-value="canh0">
        <span class="image-number">00</span>
    </div>
    <div class="image-item">
        <img src="/images/webshop/15001.png" alt="Image 2" data-value="canh1">
        <span class="image-number">01</span>
    </div>
    <div class="image-item">
        <img src="/images/webshop/15002.png" alt="Image 3" data-value="canh2">
        <span class="image-number">02</span>
    </div>
	<div class="image-item">
        <img src="/images/webshop/15003.png" alt="Image 3" data-value="canh3">
        <span class="image-number">03</span>
    </div>
	<div class="image-item">
        <img src="/images/webshop/15004.png" alt="Image 3" data-value="canh4">
        <span class="image-number">04</span>
    </div>
	
	<div class="image-item">
        <img src="/images/webshop/15074.png" alt="Image 3" data-value="canh74">
        <span class="image-number">74</span>
    </div>
	<div class="image-item">
        <img src="/images/webshop/15075.png" alt="Image 3" data-value="canh75">
        <span class="image-number">75</span>
    </div>
	<div class="image-item">
        <img src="/images/webshop/15082.png" alt="Image 3" data-value="canh82">
        <span class="image-number">82</span>
    </div>
	<div class="image-item">
        <img src="/images/webshop/15083.png" alt="Image 3" data-value="canh83">
        <span class="image-number">83</span>
    </div>
	<div class="image-item">
        <img src="/images/webshop/15084.png" alt="Image 3" data-value="canh84">
        <span class="image-number">84</span>
    </div>
	<div class="image-item">
        <img src="/images/webshop/15085.png" alt="Image 3" data-value="canh85">
        <span class="image-number">85</span>
    </div>
	<div class="image-item">
        <img src="/images/webshop/15086.png" alt="Image 3" data-value="canh86">
        <span class="image-number">86</span>
    </div>
...
<form action="canh-pt" method="POST" id="info_form">
    ...
    <select name="new_info" id="new_info" required>
	 ...
	 <label for="new_canh">Chọn id cánh:</label>
    <select name="new_canh" id="new_canh" required>
		 ...
		 <option value="canh74">74</option>
		 <option value="canh75">75</option>
		 <option value="canh82">82</option>
		 <option value="canh83">83</option>
		 <option value="canh84">84</option>
		 <option value="canh85">85</option>
		<option value="canh86">86</option>
